...
function App(){
 ...
 <div className="ticker"><span>*** POWER TO THE PLAYERS *** MIDNIGHT RELEASE AT SHERWOOD MALL *** <a href={X_URL} target="_blank" rel="noreferrer">X TRANSMISSION: @RHTG69I</a> *** <a href={TG_URL} target="_blank" rel="noreferrer">TELEGRAM BUNKER: t.me/RHTG69I</a> *** &gt;&gt;58291469 (OP) IS A FOX *** SAGE GOES IN ALL FIELDS *** GAMESTOP TRADE-IN VALUE: $6.90 OR 69,000 STORE POINTS *** PRINCE JOHN SHORT POSITION LIQUIDATED *** GLOWIES DETECTED IN THREAD *** ROBIN NEON CANDLE DETECTED *** LURK MOAR *** LITTLE JOHN IS HOLDING THE BAG *** IT HAS BEEN TWELVE FOR YEARS *** </span></div>
 ...
 <main>
  ...
  <nav>{links.map(([t,h])=><a href={h} key={t}>{t}</a>)}<a href="#buy">BUY THE DIP</a><a className="xnav" href={X_URL} target="_blank" rel="noreferrer">X TRANSMISSION ↗</a><a className="tgnav" href={TG_URL} target="_blank" rel="noreferrer">TELEGRAM BUNKER ↗</a></nav>
  ...
  <section id="welcome" className="hero">
   ...
   <a className="tgsignal" href={TG_URL} target="_blank" rel="noreferrer"><span>✦ ENCRYPTED</span> ENTER THE SHERWOOD GROUP CHAT // t.me/RHTG69I <ArrowUpRight/></a>
 ...
 </main><div className="socialsignals"><a className="xfixed" href={X_URL} target="_blank" rel="noreferrer" aria-label="Follow RHTG69I on X"><b>X</b><span>@RHTG69I<br/>SIGNAL FOUND</span></a><a className="tgfixed" href={TG_URL} target="_blank" rel="noreferrer" aria-label="Join RHTG69I on Telegram"><b>➤</b><span>TELEGRAM<br/>BUNKER OPEN</span></a></div></>}
